  ...
  return (
    <ThemeGlobalHexo.Provider value={{ searchModal }}>
      <div
        ...
        <main
          id='wrapper'
          className={`${siteConfig('HEXO_HOME_BANNER_ENABLE', null, CONFIG) ? 'pt-0' : 'pt-24'} bg-hexo-background-gray dark:bg-black w-full md:px-8 lg:px-24 min-h-screen relative`}>
          <div
            id='container-inner'
            className={
