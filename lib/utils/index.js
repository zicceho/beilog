 ...
 */
const externalResourcePromises = new WeakMap()
...
export function loadExternalResource(url, type = 'js') {
  ...
  if (elements.length > 0) {
    // Tags inserted elsewhere may already have loaded.
    return externalResourcePromises.get(elements[0]) || Promise.resolve(url)
  }
  ...
  externalResourcePromises.set(tag, promise)
