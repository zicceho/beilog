...
import { getEpisodeArchivePage } from '@/lib/utils/episodes' // <--- 新增的一行导入
...
export async function resolvePostProps({ prefix, slug, suffix, locale, from }) {
  ...
  // <--- 这里新增一行：自动计算当前节目所在页码，用于精准跳转
  props.episodeArchivePage = getEpisodeArchivePage(props.allPages, post)
